...
namespace RoamingApp.Migrations.SeedData
{
    public class TenantRoleAndUserBuilder
    {
        private readonly RoamingAppDbContext _context;
        private readonly int _tenantId;

        public TenantRoleAndUserBuilder(RoamingAppDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            if (adminRole == null)
            {
                ...
                var permissions = PermissionFinder
                    .GetAllPermissions(new RoamingAppAuthorizationProvider())
